    ...
    <div className="flex flex-col items-center justify-start pt-20 lg:pt-0 bg-white w-full text-black py-16 mainCatgeroryContainer">
      <div className="bg-white p-8 sm:p-12 md:p-16 flex flex-col items-center w-full max-w-2xl lg:max-w-xl text-left">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          This website is operated by Tarakaya Artificial OPC private Limited. Throughout the site, the terms “we”, “us” and “our” refer to Tarakaya Silver. Tarakaya Artificial offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
