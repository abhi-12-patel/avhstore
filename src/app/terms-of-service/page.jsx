  ...
  return (
    <div className="flex flex-col items-center justify-start pt-20 lg:pt-0 bg-white w-full text-black py-16 mainCatgeroryContainer">
      <div className="bg-white p-8 sm:p-12 md:p-16 flex flex-col items-center w-full max-w-2xl lg:max-w-xl text-left">
        ...
        <h2 className="text-3xl font-normal text-gray-800 mb-4">OVERVIEW</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          This website is operated by AVH Store Artificial  private Limited. Throughout the site, the terms “we”, “us” and “our” refer to AVH Store Silver. AVH Store Artificial offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-8">
          <li className="mb-2">(a) for any unlawful purpose;</li>
          <li className="mb-2">(b) to solicit others to perform or participate in any unlawful acts;</li>
          <li className="mb-2">(c) to violate any international, federal, provincial or state regulations, rules, laws, or local ordinances;</li>
          <li className="mb-2">(d) to infringe upon or violate our intellectual property rights or the intellectual property rights of others;</li>
          <li className="mb-2">(e) to harass, abuse, insult, harm, defame, slander, disparage, intimidate, or discriminate based on gender, sexual orientation, religion, ethnicity, race, age, national origin, or disability;</li>
          <li className="mb-2">(f) to submit false or misleading information;</li>
          <li className="mb-2">(g) to upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the Service or of any related website, other websites, or the Internet;</li>
          <li className="mb-2">(h) to collect or track the personal information of others;</li>
          <li className="mb-2">(i) to spam, phish, pharm, pretext, spider, crawl, or scrape;</li>
          <li className="mb-2">(j) for any obscene or immoral purpose; or</li>
        ...
        <p className="text-gray-700 leading-relaxed mb-8">
          You expressly agree that your use of, or inability to use, the Service is at your sole risk. The Service and all products and Services delivered to you through the Service are (except as expressly stated by us) provided 'as is' and 'as available' for your use, without any representation, warranties or conditions of any kind, either express or implied, including all implied warranties or conditions of merchantability, merchantable quality, fitness for a particular purpose, durability, title, and non-infringement. In no case shall AVH Store Silver, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, Service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the Service or any products procured using the Service, or for any other claim related in any way to your use of the Service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the Service or any content (or product) posted, transmitted, or otherwise made available via the Service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
        </p>

        <h2 className="text-3xl font-normal text-gray-800 mb-4 text-[clamp(1.5rem,5vw,3rem)]">SECTION 14 - INDEMNIFICATION</h2>
        <p className="text-gray-700 leading-relaxed mb-8">
          You agree to indemnify, defend and hold harmless AVH Store Artificial and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        </p>
        ...
        <h2 className="text-3xl font-normal text-gray-800 mb-4">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
